...
if( !function_exists( 'otw_lssw_init' ) ){
	...
	function otw_lssw_init(){
		...
		$otw_lssw_shortcode_object->shortcodes['unordered_list'] = array( 'title' => esc_html__('Unordered list', 'otw_lssw'),'enabled' => true,'children' => false, 'parent' => false, 'order' => 15,'path' => dirname( __FILE__ ).'/otw_components/otw_shortcode/', 'url' => $otw_lssw_plugin_url.'include/otw_components/otw_shortcode/', 'dialog_text' => $otw_lssw_dialog_text  );
		$otw_lssw_shortcode_object->shortcodes['ordered_list'] = array( 'title' => esc_html__('Ordered list', 'otw_lssw'),'enabled' => true,'children' => false, 'parent' => false, 'order' => 16,'path' => dirname( __FILE__ ).'/otw_components/otw_shortcode/', 'url' => $otw_lssw_plugin_url.'include/otw_components/otw_shortcode/', 'dialog_text' => $otw_lssw_dialog_text  );
...
if( !function_exists( 'otw_lssw_init_admin_menu' ) ){
	...
	function otw_lssw_init_admin_menu(){
		...
		add_menu_page(__('Lists Shortcode And Widget', 'otw_lssw'), esc_html__('Lists Shortcode And Widget', 'otw_lssw'), 'manage_options', 'otw-lssw-settings', 'otw_lssw_settings', $otw_lssw_plugin_url.'images/otw-sbm-icon.png');
		add_submenu_page( 'otw-lssw-settings', esc_html__('Settings', 'otw_lssw'), esc_html__('Settings', 'otw_lssw'), 'manage_options', 'otw-lssw-settings', 'otw_lssw_settings' );
